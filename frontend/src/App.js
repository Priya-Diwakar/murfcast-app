...
function App() {
  ...
  const [voice, setVoice] = useState('en_us_1');
  ...
  return (
    <div style={{ padding: '30px', fontFamily: 'Arial, sans-serif', backgroundColor: '#f5f5f5' }}>
      <h1>🎙️ MurfCast: AI Voice to Video</h1>
      <p>This is your React frontend for adding AI-generated voiceovers to muted videos.</p>
